      ...
      >
        <div className="p-4">
          ...
          <div className="mt-4 md:mt-0">
            {userInfo?.role === "admin" && (
              <h2 className="dashboard-badge bg-green-200 text-green-800">
                ADMIN
              </h2>
            )}
            {userInfo?.role === "travelManager" && (
              <h2 className="dashboard-badge bg-purple-200 text-purple-800">
                TRAVEL MANAGER
              </h2>
            )}
            {userInfo?.role === "eventManager" && (
              <h2 className="dashboard-badge bg-teal-200 text-teal-800">
                EVENT MANAGER
              </h2>
            )}
            {userInfo?.role === "entertainmentManager" && (
              <h2 className="dashboard-badge bg-amber-200 text-amber-800">
          ...
          <ul className="menu space-y-2 w-full">
            {userInfo?.role === "admin" && (
              <>
                ...
                <li onClick={closeMenu}>
                  ...
                  >
                    <MdEmojiEvents /> Manage Events
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/manageTravel"
                    className={getNavLinkClass}
                  >
                    <FaBus /> Manage Travel
                  </NavLink>
                ...
                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/manageEntertainments"
                    className={getNavLinkClass}
                  >
                    <BiMoviePlay /> Manage Entertainments
                  </NavLink>
                </li>
            ...
            {userInfo?.role === "eventManager" && (
              <>
                ...
                <li onClick={closeMenu}>
                  <NavLink to="/dashboard/addEvent" className={getNavLinkClass}>
                    <TbHomePlus /> Add Post
                  </NavLink>
                </li>
                ...
                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/ticketSold"
                    className={getNavLinkClass}
                  >
                    <HiCurrencyDollar /> Ticket Sold
                  </NavLink>
                </li>
              ...
              <>
                ...
                <li onClick={closeMenu}>
                  <NavLink
                    ...
                    className={getNavLinkClass}
                  >
                    <TbHomePlus /> Add Bus Service
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/MyBusServices"
                    className={getNavLinkClass}
                  >
                    <FaList /> My Bus Services
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/soldTickets"
                    className={getNavLinkClass}
                  >
                    <HiCurrencyDollar /> Ticket Sold
                  </NavLink>
            ...
            {userInfo?.role === "entertainmentManager" && (
              <>
                ...
                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/addcineplex"
                    className={getNavLinkClass}
                  >
                    <TbHomePlus /> Add Cinema Hall
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink to="/dashboard/addmovie" className={getNavLinkClass}>
                    <TbHomePlus /> Add Movie Show
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/ticketcineplex"
                    className={getNavLinkClass}
                  >
                    <HiCurrencyDollar /> Ticket Manager
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/managemovie"
                    className={getNavLinkClass}
                  >
                    <FaHouseCircleExclamation /> Manage Movies
                  </NavLink>
                </li>

                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/managecineplex"
                    className={getNavLinkClass}
                  >
                    <FaList /> Manage Halls
                  </NavLink>
            ...
            {userInfo?.role === "user" && (
              <>
                ...
                <li onClick={closeMenu}>
                  <NavLink
                    to="/dashboard/ticket-bought"
                    className={getNavLinkClass}
                  >
                    <FaWallet /> Ticket Bought
                  </NavLink>
                </li>
