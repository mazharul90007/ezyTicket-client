...
import useAllEvents from "../../../../Hooks/TrevalHook/EventHook/useAllEvents";

const MyAddedEvents = () => {
  const axiosSecure = useAxiosSecure();
  const { allEvents, isLoading, isError, refetch } = useAllEvents();
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-md w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
            <button
              ...
              className="absolute top-2 right-2 btn btn-sm btn-circle bg-red-200 text-red-500 border border-red-500 font-semibold"
            >
              ✕
            </button>
              ...
              <div className="form-control w-full">
                ...
                <input
                  ...
                  {...register("totalTickets", {
                    ...
                    valueAsNumber: true,
                    validate: (value) =>
                      value >= selectedEvent?.soldTickets ||
                      `Total tickets can't be less than sold tickets (${selectedEvent?.soldTickets})`,
                  })}
