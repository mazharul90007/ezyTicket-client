    ...
    return (
        <div className="bg-background py-16">
            <div className="w-11/12 mx-auto">
                <p className="text-center text-xl md:text-2xl font-semibold text-supporting mb-2 md:mb-1">
                    One Platform, Endless Possibilities – The Best Ticketing System Online.
                </p>
                <h2 className="text-2xl md:text-4xl text-main font-bold text-center">EzyTicket <span className="text-gray-800">Your One-Stop Solution for Hassle-Free Ticketing</span></h2>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 py-8">
                    {/* Bus */}
                    <div className="md:col-span-1 shadow p-8 bg-white rounded-lg cursor-pointer hover:scale-105 transform transition-transform">
