...
const marqueeMovies = [
  ...
  },
  {
    id: 2,
    title: "Inception",
    image: "https://static1.srcdn.com/wordpress/wp-content/uploads/2019/12/Inception.jpg?q=50&fit=crop&w=1140&h=&dpr=1.5",
    description:
          ...
          {marqueeMovies.map((movie) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-black backdrop-blur-2xl p-4 text-center text-white opacity-0 group-hover:opacity-80  transition-all duration-400 ">
                <h3 className="text-2xl font-bold text-[#ff014f]">{movie.title}</h3>
