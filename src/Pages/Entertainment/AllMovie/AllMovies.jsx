...
const AllMovies = () => {
  ...
  return (
    <section  className={`py-24 px-4 md:px-10 bg-gradient-to-br ${
      ...
      <div className="flex flex-col gap-8 md:grid md:grid-cols-5 md:gap-10 overflow-x-auto no-scrollbar md:overflow-visible">
        {trendingMovies.map((movie) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <button className="mt-4 w-full bg-purple-600 hover:bg-purple-700 transition text-white py-2 rounded-full font-semibold">
                Book Now
              </button>
            </div>
          </div>
