    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center  justify-end text-center">
              ...
              <Link to='/travel/bus-reservation' className="text-2xl -mb-7 text-main bg-supporting h-14 w-14 rounded-full flex justify-center items-center"><FaArrowRight /></Link>
            </div>
        </div>
    )
}
